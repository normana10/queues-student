 ...
 * @param <Object>
 */
public class LLNode<Object> {

	private Object data;
	private LLNode<Object> next;

	/**
	 * Creates a {@link LLNode} with the specified data and doesn't
	 * reference another {@link LLNode}
	 * @param elem the data to store
	 * @throws NullPointerException if {@code data} is {@code null}
	 */
	public LLNode(Object elem) {
		if (elem == null)
	 ...
	 */
	public void setNext(LLNode<Object> next) {
		this.next = next;
	}
